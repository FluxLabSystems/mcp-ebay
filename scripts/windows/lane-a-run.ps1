...
Write-Host '   browser.session_open (deviceId "default") -> browser.navigate to an'
Write-Host '   eBay search (https://www.ebay.ca/sch/i.html?_nkw=lego) or a Kijiji'
Write-Host '   search (https://www.kijiji.ca/b-buy-sell/canada?q=lego&radius=45&address=M6H+2W9)'
Write-Host '   -> browser.extract returns the listing candidates on either.'
Write-Host ''
