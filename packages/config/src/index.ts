...
export const GatewayEnvSchema = z
  .object({
    ...
    SHOP_INGEST_TOKEN: z.string().min(1).optional(),
    /**
  ...
  .check((ctx) => {
    ...
    const anyIngestToken =
      ...
      env.SHOP_INGEST_TOKEN !== undefined;
      ...
      parsed.DASHBOARD_API_BASE_URL === undefined
        ...
        : {
            ...
            tokens: {
              ...
              ...(parsed.SHOP_INGEST_TOKEN === undefined ? {} : { shop: parsed.SHOP_INGEST_TOKEN }),
            },
          },
    countdown:
...
export const AgentEnvSchema = z.object({
   ...
   */
  AGENT_SITE_PROFILES: z.string().default('ebay.ca.v1,kijiji.ca.v1,zazzle.com.v1,wardrobe-vendors.v1,office-sources.v1,jobs-sources.v1'),
  /**
