...
import { jobsSourcesSiteProfile } from '@browser-bridge/site-jobs';
...
const SITE_PROFILES: ReadonlyMap<string, SitePolicyProfile> = new Map(
  [ebaySiteProfile, kijijiSiteProfile, zazzleSiteProfile, wardrobeVendorsSiteProfile, officeSourcesSiteProfile, jobsSourcesSiteProfile].map((profile) => [
    profile.id,
    profile,
  ]),
);
