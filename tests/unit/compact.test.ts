...
describe('compact item records tolerate the record shape they are given', () => {
  ...
  it('flattens a Kijiji ad, unwrapping the location text envelope', () => {
    const compact = compactKijijiAd({
      ...
      sellerType: 'owner',
      sellerId: field('81273541'),
      sellerListingsUrl: field('https://www.kijiji.ca/o-profile/81273541/1'),
    ...
    expect(compact).toEqual({
      ...
      postedAt: '2026-08-28T14:30:00Z',
      sellerName: 'Dave',
      // The seller drill-down surface survives compaction (2026-09-04).
      sellerId: '81273541',
      sellerListingsUrl: 'https://www.kijiji.ca/o-profile/81273541/1',
      sellerListingCount: 12,
      description: 'Mixed bricks, no minifigs.',
      descriptionFull: null,
      descriptionFullOffset: null,
